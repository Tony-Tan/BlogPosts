...
下面简单的分割和平滑，然后进行合并。
原图：
![这里写图片描述](DIP-10-4-彩色图像-图像分割-彩色空间分割/20150318113150759.png)

分割（使用简单的RGB模型，肤色分割点简单选取，所以效果不是很好）：
![这里写图片描述](DIP-10-4-彩色图像-图像分割-彩色空间分割/20150318113043362.png)

平滑后合并
![这里写图片描述](DIP-10-4-彩色图像-图像分割-彩色空间分割/20150318113241131.png)

原图：
![这里写图片描述](DIP-10-4-彩色图像-图像分割-彩色空间分割/20150318113448818.png)

分割结果：
![这里写图片描述](DIP-10-4-彩色图像-图像分割-彩色空间分割/20150318113340174.png)
