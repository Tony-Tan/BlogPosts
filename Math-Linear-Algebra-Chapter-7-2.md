---
title: 机器学习基础之线性代数】7-2:The Matrix of a Linear Transformation
categories:
  - Mathematic
  - Linear Algebra
tags:
...
线性代数的应用会写五到七篇，也就是说我还要写半个月来完成剩下的部分，好吧应用部分实在是丰富多彩还是学学吧，矩阵数值计算就跳过了，最后复数矩阵加上快速傅里叶变换，好吧，整个一套下来果然还需要一个月，我的概率都等不及了，加快速度吧。
...
1. 对于求导，我们从输入空间 $V=(1,x,x^2,x^3)$ 求导后输出向量的空间基是 $W=(1,2x,3x^2)$ 对应的是 $3\times 4$ 的矩阵
