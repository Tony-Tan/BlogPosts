...
本站的内容全部是关于机器学习，深度学习，人工智能以及相关基础数学知识，其中绝大部分为博主原创，如有帮助欢迎大家持续关注，研究与分享是促进所有学科发展的重要原因，本网站希望帮助更多的希望入门人工智能，以及想更加深入研究人工智能的同学们一个探讨交流的平台。
...
- 数学基础
  ...
  - 分析
    ...
    - 数学分析
      - 《陶哲轩实分析》（包含习题解答）
        - [1.0 数学分析介绍](http://www.face2ai.com/Math-Analysis-0-0-Introduction/)
        - [2.0 自然数概述](http://www.face2ai.com/Math-Analysis-2-0-The-Natural-Numbers/)
        - [2.1 Peano公理](http://www.face2ai.com/Math-Analysis-2-1-The-Peano-Axioms/)
        - [2.2 加法](http://www.face2ai.com/Math-Analysis-2-2-Addition/)
        - [2.3 乘法](http://www.face2ai.com/Math-Analysis-2-3-Multiplication/)
        - [3.0 集合论](http://www.face2ai.com/Math-Analysis-3-0-Set-Theory)
        - [3.1 集合基础(Part I)](http://www.face2ai.com/Math-Analysis-3-1-Fundamentals-P1/)
        - [3.1 集合基础(Part II)](http://www.face2ai.com/Math-Analysis-3-1-Fundamentals-P2/)
        - [3.2 罗素悖论（选读）](http://www.face2ai.com/Math-Analysis-3-2-Russell-s-Paradox/)
        - [3.3 函数(I)](http://www.face2ai.com/Math-Analysis-3-3-Function/)
        - [3.3 函数(II)](http://www.face2ai.com/Math-Analysis-3-3-Function2/)
    - 实分析
    - 复分析
    - 泛函分析
    - 测度论
  ...
  - 数理统计
      - 数理统计学基础
          ...
          - [1.1 导言](http://www.face2ai.com/Math-Statistics-Basis-1-1-Introduction/)
      - 《数理统计学简史》
          - [介绍](http://www.face2ai.com/Math-Statistics-History-Introduction/)
          - [早期概率论——从萌芽到《推测术》](http://www.face2ai.com/Math-Statistics-1-0-Early-Probability-Theory/)
          - [1.1 卡丹诺的著作](http://www.face2ai.com/Math-Statistics-1-1-Cardano/)
          - [1.2 分赌本问题](http://www.face2ai.com/Math-Statistics-1-2-Gambling-Problem/)
          - [1.3 帕斯卡和费马的通信](http://www.face2ai.com/Math-Statistics-1-3-Pascal-Fermat/)
          - [1.4  惠更斯的“机遇与规律”](http://www.face2ai.com/Math-Statistics-1-4-Huygens/)
          - [1.5 《推测术》前三部分内容提要](http://www.face2ai.com/Math-Statistics-1-5-Ars-Conjectandi-First-3-Sections/)
          - [1.6 关于概率的几点看法](http://www.face2ai.com/Math-Statistics-1-6-Some-Idea-of-Probability/)
          - [1.7 伯努利大数定律](http://www.face2ai.com/Math-Statistics-1-7-Bernouli-Law-of-Large-Numbers/)
          - [2.0 狄莫弗的二项概率逼近](http://www.face2ai.com/Math-Statistics-2-0-De-Moivre-Binomial-Distribution/)
          - [2.1 狄莫弗研究的动因 ](http://www.face2ai.com/Math-Statistics-2-1-De-Moivre-Motive/)
          - [2.2 狄莫弗的初步结果](http://www.face2ai.com/Math-Statistics-2-2-De-Moivre-Naive-Result/)
  ...
  - 数值分析
      ...
      - [0.3 浮点数](http://www.face2ai.com/Math-Numerical-Analysis-0-3-Float/)
...
- 算法
  ...
  - 图像处理
    ...
    - [2.2 二维DFT](http://www.face2ai.com/DIP-2-2-二维DFT/)
    - [2.3 FFT算法理解与c语言的实现](http://www.face2ai.com/DIP-2-3-FFT算法理解与c语言的实现/)
    - [2.4 二维FFT,IFFT,c语言实现](http://www.face2ai.com/DIP-2-4-二维FFT-IFFT-c语言实现/)
    - [2.5 图像傅里叶变换（快速傅里叶变换FFT）](http://www.face2ai.com/DIP-2-5-图像傅里叶变换-快速傅里叶变换FFT/)
    - [3.0 二值图像](http://www.face2ai.com/DIP-3-0-二值图像/)
    - [3.1 二值图像-形态学处理 数学形态学](http://www.face2ai.com/DIP-3-1-二值图像-形态学处理1-数学形态学/)
    - [3.2 二值图像-形态学处理 腐蚀和膨胀](http://www.face2ai.com/DIP-3-2-二值图像-形态学处理2-腐蚀和膨胀/)
    - [3.3 二值图像-形态学处理 开操作和闭操作](http://www.face2ai.com/DIP-3-3-二值图像-形态学处理3-开操作和闭操作/)
    - [3.4 二值图像-形态学处理4 其他操作](http://www.face2ai.com/DIP-3-4-二值图像-形态学处理4-其他/)
    - [4.0 灰度图像](http://www.face2ai.com/DIP-4-0-灰度图像/)
    - [4.1 灰度图像-形态学处理](http://www.face2ai.com/DIP-4-1-灰度图像-形态学处理/)
    - [4.2 灰度图像-频域滤波 傅里叶变换之卷积](http://www.face2ai.com/DIP-4-2-灰度图像-频域滤波-傅里叶变换之卷积/)
    - [4.3 灰度图像-频域滤波 傅里叶变换之连续周期信号傅里叶级数](http://www.face2ai.com/DIP-4-3-灰度图像-频域滤波-傅里叶变换之连续周期信号傅里叶级数/)
    - [4.4 灰度图像-频域滤波 傅里叶变换之离散周期信号傅里叶级数](http://www.face2ai.com/DIP-4-4-灰度图像-频域滤波-傅里叶变换之离散周期信号傅里叶级数/)
    - [4.5 灰度图像-频域滤波 傅里叶变换之连续信号傅里叶变换（FT）](http://www.face2ai.com/DIP-4-5-灰度图像-频域滤波-傅里叶变换之连续信号傅里叶变换FT/)
    - [4.6 灰度图像-频域滤波 傅里叶变换之采样定理](http://www.face2ai.com/DIP-4-6-灰度图像-频域滤波-傅里叶变换之采样定理/)
    - [4.7 灰度图像-频域滤波 傅里叶变换之离散时间傅里叶变换(DTFT)](http://www.face2ai.com/DIP-4-7-灰度图像-频域滤波-傅里叶变换之离散时间傅里叶变换DTFT/)
    - [4.8 灰度图像-频域滤波 傅里叶变换之离散傅里叶变换(DFT)](http://www.face2ai.com/DIP-4-8-灰度图像-频域滤波-傅里叶变换之离散傅里叶变换DFT/)
    - [4.9 灰度图像-频域滤波 傅里叶变换之二维离散傅里叶变换](http://www.face2ai.com/DIP-4-9-灰度图像-频域滤波-傅里叶变换之二维离散傅里叶变换/)
    - [4.10 灰度图像-频域滤波 概论](http://www.face2ai.com/DIP-4-10-灰度图像-频域滤波-概论/)
    - [4.11 灰度图像-频域滤波 滤波器](http://www.face2ai.com/DIP-4-11-灰度图像-频域滤波-滤波器/)
    - [4.12 灰度图像-频域滤波 同态滤波](http://www.face2ai.com/DIP-4-12-灰度图像-频域滤波-同态滤波/)
    - [5.0 灰度图像-空域滤波 基础：卷积和相关](http://www.face2ai.com/DIP-5-0-灰度图像-空域滤波基础-卷积和相关/)
    - [5.1 灰度图像-图像增强 综合介绍](http://www.face2ai.com/DIP-5-1-灰度图像-图像增强-综合介绍/)
    - [5.2 灰度图像-图像增强 平滑之均值滤波、高斯滤波](http://www.face2ai.com/DIP-5-2-灰度图像-图像增强-平滑之均值滤波-高斯滤波/)
    - [5.3 灰度图像-图像增强 双边滤波 Bilateral Filtering](http://www.face2ai.com/DIP-5-3-灰度图像-图像增强-双边滤波BilateralFiltering/)
    - [5.4 灰度图像-图像增强 中值滤波](http://www.face2ai.com/DIP-5-4-灰度图像-图像增强-中值滤波/)
    - [5.5 灰度图像-图像增强 锐化基础](http://www.face2ai.com/DIP-5-5-灰度图像-图像增强-锐化基础/)
    - [5.6 灰度图像--图像增强 拉普拉斯算子](http://www.face2ai.com/DIP-5-6-灰度图像-图像增强-拉普拉斯算子/)
    - [5.7 灰度图像-图像增强 非锐化掩蔽 （Unsharpening Mask）](http://www.face2ai.com/DIP-5-7-灰度图像-图像增强-非锐化掩蔽UnsharpeningMask/)
    - [5.8 灰度图像-图像增强 Robert算子、Sobel算子](http://www.face2ai.com/DIP-5-8-灰度图像-图像增强-Robert算子-Sobel算子/)
    - [5.9 灰度图像--图像增强 灰度变换](http://www.face2ai.com/DIP-5-9-灰度图像-图像增强-灰度变换/)
    - [5.10 灰度图像--图像增强 直方图均衡化（Histogram Equalization)](http://www.face2ai.com/DIP-5-10-灰度图像-图像增强-直方图均衡化HistogramEqualization/)
    - [5.11 灰度图像-图像增强 直方图匹配（规定化）Histogram Specification](http://www.face2ai.com/DIP-5-11-灰度图像-图像增强-直方图匹配-规定化-HistogramSpecification/)
    - [6.0 灰度图像-图像分割 综合介绍](http://www.face2ai.com/DIP-6-0-灰度图像-图像分割-综合介绍/)
    - [6.1 灰度图像-图像分割 边缘模型](http://www.face2ai.com/DIP-6-1-灰度图像-图像分割-边缘模型/)
    - [6.2 灰度图像-图像分割 边缘检测算子 综述](http://www.face2ai.com/DIP-6-2-灰度图像-图像分割-边缘检测算子-综述/)
    - [6.3 灰度图像-图像分割 Robert算子](http://www.face2ai.com/DIP-6-3-灰度图像-图像分割-Robert算子/)
    - [6.4 灰度图像-图像分割 Sobel算子](http://www.face2ai.com/DIP-6-4-灰度图像-图像分割-Sobel算子/)
    - [6.5 灰度图像-图像分割 Prewitt算子](http://www.face2ai.com/DIP-6-5-灰度图像-图像分割-Prewitt算子/)
    - [6.6 灰度图像-图像分割 Scharr算子](http://www.face2ai.com/DIP-6-6-灰度图像-图像分割-Scharr算子/)
    - [6.7 灰度图像-图像分割 Sobel算子，Prewitt算子和Scharr算子平滑能力比较](http://www.face2ai.com/DIP-6-7-灰度图像-图像分割-算子平滑能力比较/)
    - [6.8 灰度图像-图像分割 Canny边缘检测](http://www.face2ai.com/DIP-6-8-灰度图像-图像分割-Canny边缘检测/)
    - [6.9 灰度图像-图像分割 Marr-Hildreth算子（LoG算子）](http://www.face2ai.com/DIP-6-9-灰度图像-图像分割-Marr-Hildreth算子-LoG算子/)
    - [6.10 灰度图像-图像分割 霍夫变换(Hough Transform)--直线](http://www.face2ai.com/DIP-6-10-灰度图像-图像分割-霍夫变换HoughTransform-直线/)
    - [7.0 灰度图像-图像分割 阈值处理综述](http://www.face2ai.com/DIP-7-0-灰度图像-图像分割-阈值处理综述/)
    - [7.1 灰度图像-图像分割 阈值处理之平均阈值](http://www.face2ai.com/DIP-7-1-灰度图像-图像分割-阈值处理之平均阈值/)
    - [7.2 灰度图像-图像分割 阈值处理之P-Tile阈值](http://www.face2ai.com/DIP-7-2-灰度图像-图像分割-阈值处理之P-Tile阈值/)
    - [7.3 灰度图像--图像分割 阈值处理之迭代均值阈值](http://www.face2ai.com/DIP-7-3-灰度图像-图像分割-阈值处理之迭代均值阈值/)
    - [7.4 灰度图像-图像分割 阈值处理之谷底阈值、峰顶平均](http://www.face2ai.com/DIP-7-4-灰度图像-图像分割-阈值处理之谷底阈值-峰顶平均/)
    - [7.5 灰度图像-图像分割 阈值处理之OTSU阈值](http://www.face2ai.com/DIP-7-5-灰度图像-图像分割-阈值处理之OTSU阈值/)
    - [7.6 灰度图像--图像分割 阈值处理之补充说明](http://www.face2ai.com/DIP-7-6-灰度图像-图像分割-阈值处理之补充说明/)
    - [7.7 灰度图像-图像分割 阈值处理之局部阈值](http://www.face2ai.com/DIP-7-7-灰度图像-图像分割-阈值处理之局部阈值/)
    - [7.8 灰度图像-图像分割 区域分割之区域生长](http://www.face2ai.com/DIP-7-8-灰度图像-图像分割-区域分割之区域生长/)
    - [7.9 灰度图像-图像分割 区域分割之区域分离](http://www.face2ai.com/DIP-7-9-灰度图像-图像分割-区域分割之区域分离/)
    - [7.10 灰度图像-图像分割 区域分割之分水岭算法](http://www.face2ai.com/DIP-7-10-灰度图像-图像分割-区域分割之分水岭算法/)
    - [8.0 彩色模型，CIE XYZ，CIE RGB](http://www.face2ai.com/DIP-8-0-彩色模型-CIEXYZ-CIERGB/)
    - [8.1 彩色图像-色彩空间 综述](http://www.face2ai.com/DIP-8-1-彩色图像-色彩空间-综述/)
    - [8.2 彩色图像-色彩空间 RGB系列](http://www.face2ai.com/DIP-8-2-彩色图像-色彩空间-RGB系列/)
    - [8.3 彩色图像-色彩空间 CMY(K)空间](http://www.face2ai.com/DIP-8-3-彩色图像-色彩空间-CMY-K空间/)
    - [8.4 彩色图像-色彩空间 YIQ 、YUV 、YCbCr 、YC1C2 和I1I2I3](http://www.face2ai.com/DIP-8-4-彩色图像-色彩空间-YIQ-YUVYCbCr-YC1C2和I1I2I3/)
    - [8.5 彩色图像-色彩空间 CIELAB、CIELUV](http://www.face2ai.com/DIP-8-5-彩色图像-色彩空间-CIELAB-CIELUV/)
    - [8.6 彩色图像-色彩空间 HSI(HSL)、HSV(HSB)](http://www.face2ai.com/DIP-8-6-彩色图像-色彩空间-HSI-HSL-HSV-HSB/)
    - [8.7 彩色图像-色彩空间 总结](http://www.face2ai.com/DIP-8-7-彩色图像-色彩空间-总结/)
    - [9.1 彩色图像-伪彩处理 灰度图转伪彩色图像](http://www.face2ai.com/DIP-9-1-彩色图像-伪彩处理-灰度图转伪彩色图像/)
    - [9.2 彩色图像-彩色变换 补色处理](http://www.face2ai.com/DIP-9-2-彩色图像-彩色变换-补色处理/)
    - [10.1 彩色图像-图像增强 直方图增强](http://www.face2ai.com/DIP-10-1-彩色图像-图像增强-直方图增强/)
    - [10.2 彩色图像-图像增强 图像平滑](http://www.face2ai.com/DIP-10-2-彩色图像-图像增强-图像平滑/)
...
- 语言
  - C/C++
      - 《30天自制操作系统》
          ...
          - [汇编和C](https://face2ai.com/《30天自制操作系统》学习笔记--第4天/)
          - [GDT IDT](https://face2ai.com/《30天自制操作系统》学习笔记--第5天/)
          - [中断处理](https://face2ai.com/《30天自制操作系统》学习笔记--第6天/)
          - [中断](https://face2ai.com/《30天自制操作系统》学习笔记--第7天/)
          - [鼠标](https://face2ai.com/《30天自制操作系统》学习笔记--第8天/)
          - [内存管理](https://face2ai.com/《30天自制操作系统》学习笔记--第9天/)
          - [内存管理和叠加处理](https://face2ai.com/《30天自制操作系统》学习笔记--第10天/)
          - [定时器](https://face2ai.com/《30天自制操作系统》学习笔记--第11天/)
          - [计时器](https://face2ai.com/《30天自制操作系统》学习笔记--第12天/)
          - [MAC环境搭建](https://face2ai.com/《30天自制操作系统》学习笔记--番外篇之Mac环境下的工具介绍/)
          - [Mac环境搭建](https://face2ai.com/《30天自制操作系统》学习笔记--Mac环境搭建/)
          - [MAC下的工具](https://face2ai.com/《30天自制操作系统》学习笔记--Mac下工具的使用/)
          - [FIFO](https://face2ai.com/《30天自制操作系统》学习笔记--第13天/)
          - [高分辨率](https://face2ai.com/《30天自制操作系统》学习笔记--第14天/)
          - [多任务I](https://face2ai.com/《30天自制操作系统》学习笔记--第15天/)
          - [多任务II](https://face2ai.com/《30天自制操作系统》学习笔记--第16天/)
