...
## 算法原理
对灰度图像进行平滑的文章：
[1、均值，高斯平滑](http://tony4ai.com/DIP-5-2-灰度图像-图像增强-平滑之均值滤波-高斯滤波/)
[2、双边滤波](http://tony4ai.com/DIP-5-3-灰度图像-图像增强-双边滤波BilateralFiltering/)
[3、中值滤波](http://tony4ai.com/DIP-5-4-灰度图像-图像增强-中值滤波/)
