---
title: 【机器学习基础之线性代数】6-7:Singular Value Decomposition(SVD)
categories:
  - Mathematic
  - Linear Algebra
tags:
...
其实这里隐藏了一个重要的知识点，就是四个空间的那课，矩阵的rowspace和nullspace正交column space与left nullspace正交，而V本来是A的行空间正交基，那么添加的一定是Nullspace中的正交基，以保证矩阵正交，所以完美结合，（如果忘了四个空间[点击查看](http://tony4ai.com/2017/10/17/Math-Linear-Algebra-Chapter-4-1/)）
...
回忆一下正定矩阵关于椭圆的那个[例子](http://tony4ai.com/2017/11/24/Math-Linear-Algebra-Chapter-6-5/)
