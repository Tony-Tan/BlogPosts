---
title: 【机器学习基础之线性代数】3-2:Nullspace
categories:
  - Mathematic
  - Linear Algebra
tags:
...
![例子1](Math-Linear-Algebra-Chapter-3-2/例子1.png)
...
![又一个例子](Math-Linear-Algebra-Chapter-3-2/又一个例子.png)
...
回来继续看上面C的例子
![例子的解](Math-Linear-Algebra-Chapter-3-2/例子的解.png)
