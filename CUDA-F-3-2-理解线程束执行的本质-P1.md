...
![3_10](CUDA-F-3-2-理解线程束执行的本质-P1/3_10.png)
...
执行过程如下：
![3_12](CUDA-F-3-2-理解线程束执行的本质-P1/3_12.png)
...
```
![result](CUDA-F-3-2-理解线程束执行的本质-P1/result.png)
...
![nvprof_branch](CUDA-F-3-2-理解线程束执行的本质-P1/nvprof_branch.png)
...
![nvprof_kernel3](CUDA-F-3-2-理解线程束执行的本质-P1/nvprof_kernel3.png)
...
```
![event](CUDA-F-3-2-理解线程束执行的本质-P1/event.png)
